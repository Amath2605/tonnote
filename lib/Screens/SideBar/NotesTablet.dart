// ignore_for_file: file_names, sized_box_for_whitespace, prefer_is_empty, use_build_context_synchronously
...
class _HomePageTState extends State<HomePageT> {
            ...
            onTap: () => Navigator.of(context)
                .push(MaterialPageRoute(
                    builder: (context) => EditNote(
                          Title: notesMap[reverseIndex]["titre"],
                          Content: notesMap[reverseIndex]["contenu"],
                        ...
                        noTitle
                            ...
                            : Padding(
                                padding: const EdgeInsets.only(
                                    bottom : 14, right : 40),
                                child: Expanded(
                                  child: Text(notesMap[reverseIndex]["titre"],
                                      maxLines: 1,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        children: [
          customAppBar("Tonnote", 42, leading()),
          notesMap.length != 0
              ? viewIndex == 1
                  ? Padding(
